<table border="1" style="border: 1px solid #ccc">
	...
	?>
		...
		<tr style="background-color:ffffff;"> 
			...
			<td align="center"><input type="checkbox" style="width:100px; height:16px;" id="usr_slc_<?php echo $no; ?>" name="usr_slc_<?php echo $no; ?>" value="1" <?php if($row_usrfrm->mslc==1) echo "checked"; ?> ></td>
			
			<td align="center"><input type="checkbox" style="width:100px; height:16px;" id="usr_add_<?php echo $no; ?>" name="usr_add_<?php echo $no; ?>" value="1" <?php if($row_usrfrm->madd==1) echo "checked"; ?> ></td>
			<td align="center"><input type="checkbox" style="width:100px; height:16px;" id="usr_edt_<?php echo $no; ?>" name="usr_edt_<?php echo $no; ?>" value="1" <?php if($row_usrfrm->medt==1) echo "checked"; ?> ></td>
			<td align="center"><input type="checkbox" style="width:100px; height:16px;" id="usr_dlt_<?php echo $no; ?>" name="usr_dlt_<?php echo $no; ?>" value="1" <?php if($row_usrfrm->mdel==1) echo "checked"; ?> ></td>
			<td align="center">
