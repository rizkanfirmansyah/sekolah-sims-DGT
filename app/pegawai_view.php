...
<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "main.php?menu=app&act=<?php echo obraxabrix('pegawai_view') ?>&mxKz=xm8r389xemx23xb2378e23&id="+id+" ";
		}
	}
</script>
				...
				<div class="span12">
					<div class="box">
						...
						<div class="box-content">
							<form action="" method="post" name="pegawai_view" id="pegawai_view" class="form-horizontal">
								<div>
						...
						<div class="box-content box-nomargin">
							...
							<?php
								...
								if ($delete == "xm8r389xemx23xb2378e23") {
									...
									$delete2=new delete;
									$delete2->delete_pegawai($_REQUEST['id']);
							?>
									...
									<div class="tab-pane active" id="basic">
										...
										<table class='table table-striped dataTable table-bordered' style="font-size:11px; ">
											...
											<tbody>
												...
												<?php			
													$sql=$select_view->list_pegawai($bagian, $nip, $nama, $all);			
												...
												?>
													...
													<tr>
														<td><?php echo $pegawai_view->nip ?></td>
														<td><?php echo $pegawai_view->nama ?></td>
														<td><?php echo $pegawai_view->panggilan ?></td>
														<td><?php echo $kelamin ?></td>
														<td><?php echo $pegawai_view->alamat ?></td>
														<td><?php echo $pegawai_view->bagian ?></td>
														
														<td>
															
															<a class="label label-success" href="main.php?menu=app&act=<?php echo obraxabrix('pegawai') ?>&search=<?php echo $pegawai_view->replid ?>" style="background-color: #46e916" >edit</a>
															
															
															<?php if (allowdel('frmpegawai')==1) { ?>
																&nbsp;&nbsp;
																<a class="label label-success" href="JavaScript:hapus('<?php echo $pegawai_view->replid ?>')" style="background-color: #ff0000">hapus</i> 
																</a>
															<?php } ?>
														</td>
