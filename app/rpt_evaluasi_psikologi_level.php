								...
								<div>
									...
									<table border="0">
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>
												<select name="departemen" id="departemen" class="cho" style="width:min-width:10px; height:27px; " onchange="getnissemester()" > <!--onchange="loadHTMLPost2('app/rpt_penerimaan_ajax.php','idtingkat_id','getlevel','departemen')"/>-->
													<option value="">...</option>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td id="idtingkat_id">
												<select name="idtingkat" id="idtingkat" class="cho" style="min-width:10px;  height:27px; font-size:12px; padding:0px; " onchange="getnissemester()" >
													<option value="">...</option>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>
												<select name="idkelas" id="idkelas" class="cho" style="min-width:10px; height:27px; font-size:12px; padding:0px; " onchange="getnissemester()" >
													<option value="">...</option>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>
												<select name="idsemester" id="idsemester" class="cho" style="min-width:10px; height:27px; font-size:12px; padding:0px; " >
													<option value="">...</option>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>
												<input type="text" name="nama" id="nama" style="width:250px; height:15px; font-size:12px " value="<?php echo $nama ?>">
											</td>											
										</tr>
									...
									<div class="tab-pane active" id="basic">
										...
										<table class='table table-striped dataTable table-bordered' style="font-size:11px; ">
											...
											<tbody>
												...
												<?php			
													$sql=$select_view->list_siswa('', '', $idtingkat, $idkelas, $nama, $all, $departemen);			
