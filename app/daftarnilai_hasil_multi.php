...
$sqlstr = "select a.jeniskompetensi from jeniskompetensi a where a.replid = '1' ";
$sql=$dbpdo->prepare($sqlstr);
$sql->execute();
$data=$sql->fetch(PDO::FETCH_OBJ);
$jeniskompetensi = $data->jeniskompetensi;

$sqlstr = "select a.jeniskompetensi from jeniskompetensi a where a.replid = '2' ";
$sql=$dbpdo->prepare($sqlstr);
$sql->execute();
$data=$sql->fetch(PDO::FETCH_OBJ);
$jeniskompetensi1 = $data->jeniskompetensi;
...
$sqlstr = "select a.keterangan from dasarpenilaian a where a.replid = '4'";
$sql=$dbpdo->prepare($sqlstr);
$sql->execute();
$data=$sql->fetch(PDO::FETCH_OBJ);
$aspekpenilaian1 = $data->keterangan;
    ...
    <form name="main" method="post" action="" >
		...
		<table border="1" align="left" cellspacing="0" cellpadding="5" style="border: 1px solid #ccc" >
			...
			<tr style="font-weight: bold; text-align: left;">
				...
				<td colspan="23">&nbsp;<?php echo $aspekpenilaian ?></td>
			</tr>
		...
		<?php
			include("../app/daftar_hasil1_multi.php");
		?>
