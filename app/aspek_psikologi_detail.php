								...
								<div>
									...
									<table border="0">
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="departemen" id="departemen" class='cho' style="width:min-width:10px; height:27px; " onchange="loadHTMLPost2('app/aspek_psikologi_detail_ajax.php','departemen_id','cekjenis','departemen')" >
													<option value="">...</option>
										...
										<tr>
											...
											<td>:</td>
											<td id="departemen_id">
												<select name="jenis_aspek_id" id="jenis_aspek_id" class='cho' style="width:min-width:10px; height:27px; " >
													<option value="">...</option>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="aspek" id="aspek" style="width:250px; height:16px; " value="<?php echo $aspek_psikologi_detail_data->aspek ?>"></td>
										</tr>
