												...
												?>
													...
													<tr>
														...
														<td>
															...
															<a class="label label-success" href="main.php?menu=app&act=<?php echo obraxabrix('perpustakaan') ?>&search=<?php echo $perpustakaan_view->replid ?>" style="background-color: #46e916" >edit</a>
