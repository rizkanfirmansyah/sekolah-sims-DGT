...
<script>
	...
	function checklist(lne) {	
		...
		ord_Lne = ord_Lne + '|' + document.getElementById('Lne_' + lne).value;
		$('#ord_Lne2').html('<input type="hidden" size="100" id="ord_Lne" name="ord_Lne" value="'+ ord_Lne +'" >');
				...
				<div class="span12">
										...
										<tr>
											...
											<td>
												<select name="labid" id="labid" style="width:auto;  height:20px; font-size:12px; padding:0px; " />
													...
													<?php 
														if ($_SESSION["snsu"] == 0) {
															lab_combo_select($labid); 
														} else {
															lab_combo_snsu_select($labid);
														}
													?>
												</select>
											</td>											
					...
					<div class="box">
						<div class="box-head tabs">
							<h3>Status Order Lab. Dinas Luar</h3>	
						...
						<?php
							...
							$sql=$select->list_laborder_dl($slipno, $fromdate, $todate, $periodid, $tpe, $labid, $sts, $clientid);														
						?>
						<div class="box-content box-nomargin">
							<div class="tab-content">
									<div class="tab-pane active" id="basic">
										...
										<form action="main.php?menu=app&act=laborderdl&slipno=<?php echo $slipno ?>&fromdate=<?php echo $fromdate ?>&todate=<?php echo $todate ?>&periodid=<?php echo $periodid ?>&tpe=<?php echo $tpe ?>&labid=<?php echo $labid ?>&sts=<?php echo $sts ?>&clientid=<?php echo $clientid ?>" method="post" name="laborder_dl" id="laborder_dl" class="form-horizontal" />
											...
											<tbody>
												...
												<?php			
													while ($data_master = odbc_fetch_object($sql)) {
														...
														if (date("d-m-Y", strtotime($data_master->tgl_catatan_lab))!='01-01-1970') {
															$tgl_catatan_lab	= date("d-m-Y", strtotime($data_master->tgl_catatan_lab));
														...
														if (date("d-m-Y", strtotime($data_master->tglkonsep))!='01-01-1970') {
															$tglkonsep		= date("d-m-Y", strtotime($data_master->tglkonsep));
														}
														
														$tglsertifikat = "";
														if (date("d-m-Y", strtotime($data_master->tglsertifikat))!='01-01-1970') {
															$tglsertifikat		= date("d-m-Y", strtotime($data_master->tglsertifikat));
														}
														
														$tgltu = "";
														if (date("d-m-Y", strtotime($data_master->tgltu))!='01-01-1970') {
															$tgltu		= date("d-m-Y", strtotime($data_master->tgltu));
														}
														...
														if ($data_master->konsep==0 && $data_master->sertifikat==0 && $data_master->tu==0 && $data_master->Catatan_Lab == "" && $data_master->batal == 0) {
															if ($data_master->konsep==0 && $data_master->sertifikat==0 && $data_master->tu==0 && $data_master->Catatan_Lab == "" && $data_master->batal == 0 && (date("Y-m-d", strtotime($tglselesai)) < date("Y-m-d", strtotime($nowdate))) ) {
																//If Col <= 25 Then		
														...
														} else if ( $data_master->konsep==0 && $data_master->sertifikat==0 && $data_master->tu==0 && $data_master->Catatan_Lab == "" && $data_master->batal == 0 ) {
															if ( $data_master->konsep==0 && $data_master->sertifikat==0 && $data_master->tu==0 && $data_master->Catatan_Lab == "" && $data_master->batal == 0  && (date("Y-m-d", strtotime($tglselesai)) < date("Y-m-d", strtotime($nowdate))) ) {
														...
														} else if ( $data_master->konsep==1 && $data_master->sertifikat==0 && $data_master->tu==0 && $data_master->Catatan_Lab == "" && $data_master->batal == 0 ) {
															if ( $data_master->konsep==1 && $data_master->sertifikat==0 && $data_master->tu==0 && $data_master->Catatan_Lab == "" && $data_master->batal == 0 && (date("Y-m-d", strtotime($tglselesai)) < date("Y-m-d", strtotime($nowdate))) ) {
														...
														} else if ( $data_master->konsep==1 && $data_master->sertifikat==1 && $data_master->tu==0 && $data_master->Catatan_Lab == "" && $data_master->batal == 0 ) { 
															  if ( $data_master->konsep==1 && $data_master->sertifikat==1 && $data_master->tu==0 && $data_master->Catatan_Lab == "" && $data_master->batal == 0  && (date("Y-m-d", strtotime($tglselesai)) < date("Y-m-d", strtotime($nowdate))) ) {
														...
														} else if ( $data_master->konsep==1 && $data_master->sertifikat==1 && $data_master->tu==1 && $data_master->Catatan_Lab == "" && $data_master->batal == 0 ) {
												...
												?>
													...
													<tr>
														...
														<input type="hidden" name="Lne_<?php echo $i; ?>" id="Lne_<?php echo $i; ?>" value="<?php echo $data_master->Lne ?>"> 
														...
														<!--<input type="hidden" name="noseri_<?php echo $i; ?>" id="noseri_<?php echo $i; ?>" value="<?php echo $data_master->noseri ?>">-->
														...
														<td style="<?php echo $bgcolorfinish_bawah_25 . $bgcolorfinish . $bgcolorfinish_bawah_27 . $bgcolorfinish_atas_28_bawah_29 ?>"><?php echo $data_master->OutBldCde ?></td>
														<td style="<?php echo $bgcolorfinish_bawah_25 . $bgcolorfinish . $bgcolorfinish_bawah_27 . $bgcolorfinish_atas_28_bawah_29 ?>"><?php echo $data_master->DLNo ?></td>
														...
														<td style="<?php echo $bgcolorfinish_bawah_25 . $bgcolorfinish . $bgcolorfinish_bawah_27 . $bgcolorfinish_atas_28_bawah_29 ?>"><?php echo $data_master->ItmDcr ?></td>
														...
														<!--<td style="<?php echo $bgcolorfinish_bawah_25 . $bgcolorfinish . $bgcolorfinish_bawah_27 ?>"><input type="text" name="ket_alat_<?php echo $i ?>" id="ket_alat_<?php echo $i ?>" value="<?php echo $data_master->ket_alat ?>" style="height:10px; font-size:12px " onBlur="checklist(<?php echo $i ?>)" /></td> -->
														...
														<td style="<?php echo $bgcolorfinish . $bgcolorfinish_atas_26_bawah_27 . $bgcolorfinish_bawah_27 . $bgcolorfinish_atas_28_bawah_29 ?>"><input type="text" name="tglkonsep_<?php echo $i ?>" id="tglkonsep_<?php echo $i ?>" class='datepick' style="width:120px; height:10px; font-size:12px " value="<?php echo $tglkonsep ?>" onBlur="checklist(<?php echo $i ?>)"></td>
														...
														<td style="<?php echo $bgcolorfinish . $bgcolorfinish_atas_30_bawah_31 ?>"><input type="text" name="tgltu_<?php echo $i ?>" id="tgltu_<?php echo $i ?>" class='datepick' style="width:120px; height:10px; font-size:12px " value="<?php echo $tgltu ?>" onBlur="checklist(<?php echo $i ?>)"></td>
