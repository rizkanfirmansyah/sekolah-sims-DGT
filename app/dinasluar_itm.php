	...
	*/
	...
	<!--------------------------------> 
		...
		<tr>
			...
			<td><input type="text" style="width:150px; " name="TankDcr_<?php echo $i ?>" id="TankDcr_<?php echo $i ?>" value=""/></td>
	...
	<tr>
		...
		<td id="Total2"><input type="text" style="width:100px; text-align:right; background-color: #eeffb5" readonly  name="Total" id="Total" onkeyup="formatangka('Total')" value=""/></td>
