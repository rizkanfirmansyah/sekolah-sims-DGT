										...
										<tr>
											...
											<td>
												<select name="tpe" id="tpe" style="width:auto;  height:20px; font-size:12px; padding:0px; " />
													<?php 
														if($_SESSION["snsu"] == 0) {
															type_combo_select($tpe); 
														}else{
															type_combo_snsu_select($tpe);
														}
													?>
					...
					<div class="box">
						...
						<?php
							...
							if ($_SESSION["snsu"] == 0) {
								...
								$sql=$select->list_laborder_snsu($slipno, $fromdate, $todate, $periodid, $tpe, $labid, $sts, $clientid);
							}					
											...
											<tbody>
												...
												<?php			
													while ($data_master = odbc_fetch_object($sql)) {
														...
														if (date("d-m-Y", strtotime($data_master->tglfinish))!='01-01-1970') {
															$tglfinish		= date("d-m-Y", strtotime($data_master->tglfinish));
														}
												...
												?>
													...
													<tr>
														...
														<td style="text-align:center; <?php echo $bgcolorfinish . $bgcolorfinish_atas_30_bawah_31 ; ?>"><input type="text" name="tgltu_<?php echo $i ?>" id="tgltu_<?php echo $i ?>" class='datepick' style="width:120px; height:10px; font-size:12px " value="<?php echo $tgltu ?>" onBlur="checklist(<?php echo $i ?>)"></td>
