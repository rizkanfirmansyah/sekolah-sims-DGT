...
if ($tpe != "" && $tpe != "0") {
	if ($where == "") {
		if ($tpe == "1") { $where = "Tipe : Tera/Tera Ulang"; }
		if ($tpe == "3") { $where = "Tipe : Pengujian Ijin Tipe"; }
	} else {
		if ($tpe == "1") { $where = $where . " ; Tipe : Tera Tera Ulang"; }
		if ($tpe == "3") { $where = $where . " ; Tipe : Pengujian Ijin Tipe"; }
	}
}
...
if ($tpe == "" || $tpe == "0") {
	if ($where == "") {
		$where = "Tipe : Tera/Tera Ulang dan Pengujian Ijin Tipe";
	} else {
		$where = $where . " ; Tipe : Tera/Tera Ulang dan Pengujian Ijin Tipe";
	}
}
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="DataOnline">
  ...
  <Table>
   ...
   <Row>
    <Cell ss:MergeAcross="23" ss:StyleID="judul"><Data ss:Type="String">LAPORAN ORDER STATUS</Data></Cell>
    <Cell ss:StyleID="judul"><Data ss:Type="String"></Data></Cell>
   </Row>
   <Row>
    <Cell ss:MergeAcross="20" ss:StyleID="filter"><Data ss:Type="String">' . $where . '</Data></Cell>
    <Cell ss:StyleID="judul"><Data ss:Type="String"></Data></Cell>
   </Row>';
	...
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">Objek Kalibrasi</Data></Cell>';
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">Tgl. Selesai</Data></Cell>';
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">Tgl. Kalibrasi</Data></Cell>';
	...
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">Catatan Lab</Data></Cell>';
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">Batal</Data></Cell>';
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">Catatan Batal</Data></Cell>';
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">Provinsi</Data></Cell>';
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">NIP Penera-1</Data></Cell>';
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">Nama Penera-1</Data></Cell>';
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">NIP Penera-2</Data></Cell>';
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">Nama Penera-2</Data></Cell>';
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">NIP Penera-3</Data></Cell>';
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">Nama Penera-3</Data></Cell>';
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">No. Sertifikat2</Data></Cell>';
	echo '<Cell ss:StyleID="kepala"><Data ss:Type="String">Penyerah</Data></Cell>';
	echo '</Row>';
	...
	while($data=odbc_fetch_object($sql)) {
		...
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->namabarang."</Data></Cell>";
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->objek_kalibrasi."</Data></Cell>";
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$tglselesai."</Data></Cell>";
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$tglfinish."</Data></Cell>";
		...
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->kategori."</Data></Cell>";
		...
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$catatan_lab."</Data></Cell>";
		
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->batal2."</Data></Cell>";
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->catatan_batal."</Data></Cell>";
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->ProNme."</Data></Cell>";
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->finish1nip."</Data></Cell>";
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->Penera1."</Data></Cell>";
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->finish2nip."</Data></Cell>";
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->Penera2."</Data></Cell>";
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->finish3nip."</Data></Cell>";
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->Penera3."</Data></Cell>";
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->serti."</Data></Cell>";
		echo "<Cell ss:StyleID=\"badan\"><Data ss:Type=\"String\">".$data->Penyerah."</Data></Cell>";
		echo "</Row>\n";
