								...
								<div>
									...
									<table border="0">
										...
										<tr>
											...
											<td>Suami/Istri</td>
											<td>:</td>
											<td><input type="text" name="nama_pasangan" id="nama_pasangan" style="width:250px; height:16px;" value="<?php echo $pegawai->nama_pasangan; ?>" ></td>
										...
										<tr>
											<td>Kecamatan</td>
											<td>:</td>
											<td><input type="text" name="kecamatan" id="kecamatan" style="width:150px; height:16px; " value="<?php echo $pegawai->kecamatan ?>"></td>
											
											<td style="width: 40px"></td>
											
											<td>Tanggal Nikah</td>
											<td>:</td>
											<td><input type="text" name="tanggal_nikah" class='datepick' id="tanggal_nikah" style="width:70px; height:16px;" value="<?php echo $tanggal_nikah; ?>" ></td>
										...
										<tr>
											<td>Kode Pos</td>
											<td>:</td>
											<td><input type="text" name="kode_pos" id="kode_pos" style="width:250px; height:16px;" value="<?php echo $pegawai->kode_pos; ?>" ></td>
											...
											<td>Tempat Nikah</td>
											<td>:</td>
											<td><input type="text" name="tempat_nikah" id="tempat_nikah" style="width:250px; height:16px;" value="<?php echo $pegawai->tempat_nikah; ?>" ></td>
										...
										<tr>
											<td>E-mail</td>
											<td>:</td>
											<td><input type="text" name="email" id="email" style="width:150px; height:16px; " value="<?php echo $pegawai->email ?>"></td>
											...
											<td>:</td>
											<td><input type="text" name="tempat_lahir_pasangan" id="tempat_lahir_pasangan" style="width:250px; height:16px;" value="<?php echo $pegawai->tempat_lahir_pasangan; ?>" ></td>
										...
										<tr>
											...
											<td>:</td>
											<td><input type="text" name="tanggal_lahir_pasangan" class='datepick' id="tanggal_lahir_pasangan" style="width:70px; height:16px;" value="<?php echo $tanggal_lahir_pasangan; ?>" ></td>
										...
										<tr>
											...
											<td>:</td>
											<td><input type="text" name="pekerjaan_pasangan" id="pekerjaan_pasangan" style="width:250px; height:16px;" value="<?php echo $pegawai->pekerjaan_pasangan; ?>" ></td>
										...
										<tr>
											...
											<td>Instansi Suami/Istri</td>
											<td>:</td>
											<td><input type="text" name="instansi_pasangan" id="instansi_pasangan" style="width:250px; height:16px;" value="<?php echo $pegawai->instansi_pasangan; ?>" ></td>
										...
										<tr>
											...
											<td>:</td>
											<td><input type="text" name="nip_pasangan" id="nip_pasangan" style="width:150px; height:16px; " value="<?php echo $pegawai->nip_pasangan ?>"></td>
											
											
										</tr>
										
										<tr>
											<!--<td>Mengajar di tempat lain</td>
											<td>:</td>
											<td><input type="text" name="ajar_lain" id="ajar_lain" style="width:250px; height:16px;" value="<?php echo $pegawai->ajar_lain; ?>" ></td>
											...
											<td>Nama Bank</td>
											<td>:</td>
											<td><input type="text" name="nama_bank" id="nama_bank" style="width:250px; height:16px;" value="<?php echo $pegawai->nama_bank; ?>" ></td>
										</tr>
										...
										<tr>
											...
											<td>Nama Pemilik</td>
											<td>:</td>
											<td><input type="text" name="nama_pemilik" id="nama_pemilik" style="width:150px; height:16px; " value="<?php echo $pegawai->nama_pemilik ?>"></td>
										...
										<tr>
											...
											<td>No. Rekening</td>
											<td>:</td>
											<td><input type="text" name="no_rek" id="no_rek" style="width:250px; height:16px;" value="<?php echo $pegawai->no_rek; ?>" ></td>
										</tr>
