				...
				<div class="span12">
					<div class="box">
						...
						<div class="box-content">
							<form action="" method="post" name="assesmen_observasi" id="assesmen_observasi" class="form-horizontal" onSubmit="return cekinput('tanggal,departemen,idtingkat,idkelas,nis,idpegawai,idpegawai1');">
								<div>
									<?php
									...
									<table border="0" width="100%">
										...
										<tr>
											...
											<td>:</td>
											<td width="30%">
												<input type="text" name="ref2" id="ref2" style="width:130px; height:16px; " readonly="" value="<?php echo $ref2 ?>">
											</td>
											...
											<td>&nbsp;&nbsp;</td>
                                            <td>:</td>
											<td width="30%"><input type="text" name="tanggal" class='datepick' id="tanggal" style="width:70px; height:16px; " value="<?php echo $tanggal ?>"></td>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="departemen" id="departemen" style="width:auto;  height:20px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/assesmen_observasi_ajax.php','idtingkat','gettingkat','departemen')" />
													<option value=""></option>
											...
											<td>:</td>
											<td>
												<select name="idtingkat" id="idtingkat" style="width:auto;  height:20px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/assesmen_observasi_ajax.php','idkelas','getkelas','idtingkat')" />
													<option value=""></option>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idkelas" id="idkelas" style="width:auto; height:20px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/assesmen_observasi_ajax.php','idsiswa','getsiswa','idkelas')" />
													<option value=""></option>
                                        ...
                                        <tr>
											...
											<td>:</td>
											<td>
                                                <select name="idpegawai" id="idpegawai" style="width:auto; height:27px; " />
                                                    <option value=""></option>
										...
										<tr>
											...
											<td>:</td>
											<td>
                                                <select name="idpegawai1" id="idpegawai1" style="width:auto; height:27px; " />
                                                    <option value=""></option>
