								...
								<div>
									...
									<table border="0">
                                        ...
                                        <tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>
												<select name="departemen" id="departemen" onchange="loadHTMLPost2('app/registrasi_ajax.php','dep_id','getdepartemen','departemen')" style="width:auto; height:27px; " >
													<option value=""></option>
										...
										<tr>
											...
											<td>
												<select name="idkelompok" id="idkelompok" style="width:auto; height:27px; " />
													<option value=""></option>
													<?php select_jalurmasuk($registrasi->idkelompok); ?>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												...
												<input type="radio" id="kebutuhan_khusus_chk" name="kebutuhan_khusus_chk" value="1" <?php echo $kebutuhan_khusus_chk ?> >Ya&nbsp;&nbsp;
												<input type="radio" id="kebutuhan_khusus_chk1" name="kebutuhan_khusus_chk" value="2" <?php echo $kebutuhan_khusus_chk1 ?> >Tidak
											</td>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>
												<i style="font-size: 12px; color: #ff0000">*) Jika Ya, sebutkan</i>
												<input type="text" name="kebutuhan_khusus" id="kebutuhan_khusus" style="width:200px; height:16px; " value="<?php echo $registrasi->kebutuhan_khusus ?>">
											</td>
										...
										<tr>
											<td colspan="7" align="center">
												<h4 style="color: #fff; font-weight: bold; background-color:#4b8ce4; text-align: center;"><span class="break"></span>Pilihan Jurusan Khusus SMA</h4>
											</td>
										</tr>
