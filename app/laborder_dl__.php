											...
											<tbody>
												...
												?>
													...
													<tr>
														...
														<td style="<?php echo $bgcolorfinish_bawah_25 . $bgcolorfinish . $bgcolorfinish_bawah_27 ?>"><?php echo $data_master->OutBldCde ?></td>
														<td style="<?php echo $bgcolorfinish_bawah_25 . $bgcolorfinish . $bgcolorfinish_bawah_27 ?>"><?php echo $data_master->DLNo ?></td>
														...
														<td style="<?php echo $bgcolorfinish_bawah_25 . $bgcolorfinish . $bgcolorfinish_bawah_27 ?>"><?php echo $data_master->ItmDcr ?></td>
														
														<td style="<?php echo $bgcolorfinish_bawah_25 . $bgcolorfinish . $bgcolorfinish_bawah_27 ?>"><input type="text" name="catatan_lab_<?php echo $i ?>" id="catatan_lab_<?php echo $i ?>" value="<?php echo $data_master->catatan_lab ?>" style="height:10px; font-size:12px " onBlur="checklist(<?php echo $i ?>)" /></td>
