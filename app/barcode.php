...
<script type="text/javascript">
	function print_barcode(nis) {		
		window.open('app/barcode_view.php?nis='+nis, '','825','450','resizable=1,scrollbars=1,status=0,toolbar=0')
	}
								...
								<div>
									...
									<table border="0">
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>
												<select name="idtingkat2" id="idtingkat2" style="width:auto;  height:20px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/siswa_ajax.php','idkelas2','getkelas2','idtingkat2')" />
													<option value=""></option>
										...
										<table class='table table-striped dataTable table-bordered' style="font-size:11px; ">
											<thead>
												<tr>
													...
													<th style="font-weight:bold ">NISN Asal Sekolah &nbsp;&nbsp;</th>
												...
												?>
													...
													<tr>
														...
														<td>
															...
															<input type="button" name="button" class="btn btn-info btn-sm" value="Print Barcode" onclick="print_barcode(<?php echo $siswa_view->nis ?>)" >
														</td>
