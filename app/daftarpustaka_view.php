												...
												?>
													...
													<tr>														
														...
														<td>
															...
															<a class="label label-success" href="main.php?menu=app&act=<?php echo obraxabrix('daftarpustaka') ?>&search=<?php echo $daftarpustaka_view->replid ?>" style="background-color: #46e916" >edit</a>
