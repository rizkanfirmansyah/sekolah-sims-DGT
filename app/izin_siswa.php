								...
								<div>
									...
									<table border="0">
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idtingkat" id="idtingkat" style="width:auto;  height:20px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/izin_siswa_ajax.php','idkelas','getkelas','idtingkat')" />
													<option value=""></option>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idkelas" id="idkelas" style="width:auto; height:20px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/izin_siswa_ajax.php','idsiswa','getsiswa','idkelas')" />
													<option value=""></option>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
											<td>
                                                <!--<input type="text" name="jam" id="jam" class='timepicker' style="width:70px;" value="<?php echo $jam ?>" >-->
                                                <select name="jam" id="jam" style="width:auto; height:27px; " />   
                                                    <?php select_jam($jam); ?>   
                                                </select> 
                                                :
                                                <select name="menit" id="menit" style="width:auto; height:27px; " />   
                                        ...
                                        <tr>
											...
											<td>:</td>
											<td>
                                                <select name="idjenis_izin" id="idjenis_izin" style="width:auto; height:27px; " />
                                                    <option value=""></option>
										...
										<tr>
											...
											<td>:</td>
											<td>
                                                <select name="status" id="status" style="width:auto; height:27px; " />
