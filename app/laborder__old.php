					...
					<div class="box">
						<div class="box-head tabs">
							...
							<ul class='nav nav-tabs'>
								<li class='active'>
									<a href="#basic" data-toggle="tab"></a>
								</li>
							</ul>						
						</div>
											...
											<tbody>
												...
												?>
													...
													<tr>
														...
														<input type="hidden" name="NoSertifikat_<?php echo $i; ?>" id="NoSertifikat_<?php echo $i; ?>" value="<?php echo $data_master->NoSertifikat ?>">
														...
														<td style="<?php echo $bgcolorfinish_bawah_25 . $bgcolorfinish . $bgcolorfinish_bawah_27 ?>"><input type="text" name="tglfinish_<?php echo $i ?>" id="tglfinish_<?php echo $i ?>" class='datepick' style="width:120px; height:10px; font-size:12px " value="<?php echo $tglfinish ?>" onBlur="checklist(<?php echo $i ?>)"></td>
														...
														<td><input type="text" name="no_sertifikat_<?php echo $i ?>" id="no_sertifikat_<?php echo $i ?>" value="<?php echo $data_master->no_sertifikat ?>" style="width:auto; height:15px; font-size:12px " onBlur="checklist(<?php echo $i ?>)" onKeypress="pindahKolom(event,this.id,'no_sertifikat_<?php echo $i + 1; ?>');" /></td>
