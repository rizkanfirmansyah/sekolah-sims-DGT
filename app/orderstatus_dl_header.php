...
<script>
    function submitForm(tipe)
    {
		if(tipe == 'preview') {
			...
			$("#orderstatus_dl_header").attr('action', 'app/orderstatus_dl_rpt.php')
			   .attr('target', '_BLANK');
			$("#orderstatus_dl_header").submit();
		}
		...
		if(tipe == 'excel') {
			$("#orderstatus_dl_header").attr('action', 'app/orderstatus_dl_xls.php')
			   .attr('target', '_BLANK');
			$("#orderstatus_dl_header").submit();
		}
		...
		<div class="content">
			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box">
						<div class="box-head">
							<h3>Lap. Order Status DL</h3>
						</div>
						<div class="box-content">
							<form action="" method="post" name="orderstatus_dl_header" id="orderstatus_dl_header" class="form-horizontal">
								<div>
