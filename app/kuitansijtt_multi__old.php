...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(20,3,$alamat1id,0,1,'L',true);
		$this->Ln(1);
		...
		$this->Cell(2,2,':',0,0,'L',false);
		$this->Cell(50,2, $departemen . '/' . $kelas,0,1,'L',true);
		$this->Ln(2);
	...
	function BasicTable($header,$data)
	{
		...
		$this->Cell(63,2,'Kasir',0,1,'R',false);		
		$this->Ln(8);
		
		//$size = $size + $sizeadd;
		
		$this->Cell(64,2,$getuser,0,1,'R',false);		
		$this->Ln(2);
