...
<script>
	...
	function getpenerimaan_bayar() {
		...
		//tbayar = tbayar.replace(/[^\d-.]/g,"");
		document.location.href = "penerimaanjtt_add.php?nis="+tnis+"&bayar="+tbayar+"&tcicilan="+tcicilan;
	}
...
?>		
		...
		<script language="javascript">
			getpenerimaan_update('<?php echo $nis ?>','<?php echo $total_bayar ?>','<?php echo $ref ?>');
		</script>
