...
<script>
    function submitForm(tipe)
    {
		if(tipe == 'preview') {
			...
			$("#pnbp_header").attr('action', 'app/pnbp_rpt.php')
			   .attr('target', '_BLANK');
			$("#pnbp_header").submit();
		}
		...
		if(tipe == 'excel') {
			$("#pnbp_header").attr('action', 'app/pnbp_xls.php')
			   .attr('target', '_BLANK');
			$("#pnbp_header").submit();
		}
				...
				<div class="span12">
					<div class="box">
						...
						<div class="box-content">
							<form action="" method="post" name="pnbp_header" id="pnbp_header" class="form-horizontal">
								<div>
