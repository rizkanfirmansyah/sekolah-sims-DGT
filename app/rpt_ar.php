...
<div class="page-content">		
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="rpt_ar" id="rpt_ar" class="form-horizontal" enctype="multipart/form-data" >
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-3">
                    	 <input id="all" name="all" type="checkbox" disabled value="1" <?php echo $all2 ?> >
					</div>
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
			                    	...
			                    	<th><?php if($lng==1) { echo 'Customer Name'; } else { echo 'Nama Customer'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Amount Due'; } else { echo 'Total Piutang'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Amount Paid'; } else { echo 'Total Bayar'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Balance'; } else { echo 'Sisa'; } ?></th>
			                    	<th></th>
							...
							<tbody>
                                <?php			
									$sql=$select->rpt_ar_outstanding($from_date, $to_date, $client_code, $all);			
													
									while ($row_rpt_ar=$sql->fetch(PDO::FETCH_OBJ)) {
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $row_rpt_ar->date ?></td>
					                    	<td><?php echo $row_rpt_ar->invoice_no ?></td>
				                            <td><?php echo $row_rpt_ar->client_name ?></td>
					                    	<td><?php echo $row_rpt_ar->debit_amount ?></td>
					                    	<td><?php echo $row_rpt_ar->credit_amount ?></td>
					                    	<td><?php echo $row_rpt_ar->amount ?></td>
											<td>
                                            
                                                <?php if (allowupd('rpt_ar')==1) { ?>
    												<a href="main.php?menu=app&act=<?php echo obraxabrix('rpt_ar') ?>&search=<?php echo $row_rpt_ar->invoice_no ?>" class="tooltip-success" data-rel="tooltip" title="Receipt">
    													<span class="green">
