								...
								<div>
									...
									<table border="0" width="100%" cellpadding="5">
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="departemen" id="departemen" class="cho" style="width:100px;  height:20px; font-size:12px; padding:0px; " onchange="loadHTMLPost2('app/assesmen_observasi_ajax.php','idtingkat','gettingkat','departemen')" />
													<option value="">...</option>
