								...
								<div>
									...
									<table border="0" cellpadding="5">
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="ref" id="ref" style="width:auto; height:16px;" readonly value="<?php echo $ref2; ?>" ></td>
										</tr>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="departemen" id="departemen" class="cho" style="width:100px;  height:20px; font-size:12px; padding:0px; " onchange="loadHTMLPost2('app/konseling_siswa_ajax.php','idtingkat','gettingkat','departemen')" />
													<option value="">...</option>
													<?php select_departemen($konseling_siswa_data->departemen); ?>
												</select>
											</td>
										</tr>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idtingkat" id="idtingkat" style="width:auto;  height:27px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/konseling_siswa_ajax.php','idkelas','getkelas','idtingkat')" />
													<option value=""></option>
													<?php select_tingkat_unit($konseling_siswa_data->departemen, $konseling_siswa_data->idtingkat); ?>
												</select>
											</td>	
										</tr>	
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idkelas" id="idkelas" style="width:auto; height:27px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/konseling_siswa_ajax.php','idsiswa','getsiswa','idkelas')" />
													<option value=""></option>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idsiswa" id="idsiswa" style="width:auto; height:27px; " />
													<option value=""></option>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idjenis_konseling" id="idjenis_konseling" style="width:auto; height:27px; " />
													<option value=""></option>
										...
										<tr>
											...
											<td>
												...
												<input type="hidden" id="data_file2" name="data_file2" value="<?php echo $konseling_siswa_data->data_file; ?>" >
											</td>
										</tr>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<?php if($konseling_siswa_data->data_file != "") { ?>
													<a class="label label-success" href="app/konseling_siswa_download.php?ref=<?php echo $konseling_siswa_data->ref ?>" target="_blank" title="Download"><?php echo $konseling_siswa_data->data_file; ?>
													</a>
												<?php } ?>
											</td>
										...
										*/ ?>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="nip" id="nip" style="width:auto; height:27px; " />
													<option value=""></option>
