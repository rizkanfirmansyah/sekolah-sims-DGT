								...
								<div>
									...
									<table border="0">
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="departemen" id="departemen" class="cho" style="width:min-width:10px; height:27px; " onchange="getnissemester()" >
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idtingkat" id="idtingkat" class="cho" style="width:min-width:10px; height:27px; " onchange="getnissemester()" >
													<option value="">...</option>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idkelas" id="idkelas" class="cho" style="width:min-width:10px; height:27px; " onchange="getnissemester()" >
													<option value="">...</option>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idsemester" id="idsemester" class="cho" style="min-width: 20px; height:27px; " onchange="loadHTMLPost3('app/evaluasi_psikologi_detail_ajax.php','aspek_psikologi_id','get_jenisaspek_psikologi','departemen','nis','idsemester')" >
													<option value="">...</option>
