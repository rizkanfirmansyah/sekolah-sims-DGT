								...
								<div>
									...
									<table border="0">
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>
												<select name="departemen" id="departemen" class="cho" style="width:100px;  height:20px; font-size:12px; padding:0px; " onchange="loadHTMLPost2('app/rpt_konseling_siswa_ajax.php','idtingkat','gettingkat','departemen')" />
													<option value="">...</option>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>
												<select name="idtingkat" id="idtingkat" style="width:auto;  height:27px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/rpt_konseling_siswa_ajax.php','idkelas','getkelas','idtingkat')" />
													<option value=""></option>
											...
											<td>&nbsp;&nbsp;</td>
											<td>
												<select name="idkelas" id="idkelas" style="width:auto; height:27px; font-size:12px; padding:0px; " />
													<option value=""></option>
