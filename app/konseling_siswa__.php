								...
								<div>
									...
									<table border="0">
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idtingkat" id="idtingkat" style="width:auto;  height:20px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/konseling_siswa_ajax.php','idkelas','getkelas','idtingkat')" />
													<option value=""></option>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idkelas" id="idkelas" style="width:auto; height:20px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/konseling_siswa_ajax.php','idsiswa','getsiswa','idkelas')" />
													<option value=""></option>
