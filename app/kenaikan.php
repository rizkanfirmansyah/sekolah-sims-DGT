			...
			<div class="row-fluid">
											...
											<td>
												<table>
													...
													<tr>
														...
														<td>&nbsp;&nbsp;</td>
														<td>
															<select name="idtingkat" id="idtingkat" style="width:auto;  height:27px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/kenaikan_ajax.php','idkelas','getkelas','idtingkat')" />
																<option value=""></option>
											...
											<td>
												<table>
													...
													<tr>
														...
														<td>&nbsp;&nbsp;</td>
														<td>
															<select name="idtingkat2" id="idtingkat2" style="width:auto;  height:27px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/kenaikan_ajax.php','idkelas2','getkelas2','idtingkat2')" />
																<option value=""></option>
				...
				<?php 
					if($post == "Find") {	
						...
						include_once("kenaikan_awal.php");
					} 
				?>										
