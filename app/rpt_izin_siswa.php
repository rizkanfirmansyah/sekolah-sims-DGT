								...
								<div>
									...
									<table border="0">
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>
												<select name="idtingkat" id="idtingkat" style="width:auto;  height:20px; font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/rpt_izin_siswa_ajax.php','idkelas','getkelas','idtingkat')" />
													<option value=""></option>
