<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "main.php?menu=app&act=<?php echo obraxabrix('pelajaran_view') ?>&mxKz=xm8r389xemx23xb2378e23&id="+id+" ";
		}
	}
</script>
						...
						<div class="box-content box-nomargin">
							...
							<?php
								...
								if ($delete == "xm8r389xemx23xb2378e23") {
									...
									$delete2=new delete;
									$delete2->delete_pelajaran($_REQUEST['id']);
							?>
							...
							<div class="tab-content">
									...
									<?php if (allowadd('frmpelajaran')==1) { ?>
										<div style="margin-left: 5px; margin-top: 5px; margin-bottom: 5px">
											<input type="button" name="submit" id="submit" class="btn btn-primary" value="Tambah Data" onclick="self.location='<?php echo $nama_folder . obraxabrix('pelajaran') ?>'" />
												...
												?>
													...
													<tr>
														...
														<td style="text-align: center">
															<?php if ($pelajaran_view->aktif == 1) { ?>
																<img src="img/icons/essen/16/check.png" />
															<?php } else { ?>
																<img src="img/icons/essen/16/busy.png" />
															<?php } ?>
														</td>
														<td><?php echo $pelajaran_view->ts ?></td>
														<td>
															
															<a class="label label-success" href="main.php?menu=app&act=<?php echo obraxabrix('pelajaran') ?>&search=<?php echo $pelajaran_view->replid ?>" style="background-color: #46e916" >edit</a>
															
															
															<?php if (allowdel('frmpelajaran')==1) { ?>
																&nbsp;&nbsp;
																<a class="label label-success" href="JavaScript:hapus('<?php echo $pelajaran_view->replid ?>')" style="background-color: #ff0000">hapus</i> 
																</a>
															<?php } ?>
														</td>
