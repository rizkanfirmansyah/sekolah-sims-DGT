<table border="0">
	...
	<?php 
		...
		$i = 0;
		$sql2=$select->list_dl_nik($ref);	
		$jmldata = odbc_num_rows($sql2);
		while($row_peg=odbc_fetch_object($sql2)) {	
	...
	<!--------------------------------> 
		...
		<input type="hidden" id="old_EpyCde_<?php echo $i ?>" name="old_EpyCde_<?php echo $i ?>" value="<?php echo $row_peg->EpyCde; ?>" >
		<input type="hidden" id="old_Lne_<?php echo $i ?>" name="old_Lne_<?php echo $i ?>" value="<?php echo $row_peg->Lne; ?>" >
		
		<tr>
			<td>			
				<input type="text" onKeyUp="suggest_<?php echo $i ?>(this.value,'app/js_auto/auto_epy.php?no=<?php echo $i ?>');" name="EpyCde_<?php echo $i ?>" onchange="fill2_<?php echo $i ?>();"  id="EpyCde_<?php echo $i ?>" value="<?php echo $row_peg->EpyCde ?>" style="width: 150px" />
			...
			<td><input type="text" style="width:200px; background-color: #eeffb5"  readonly name="EpyDcr_<?php echo $i ?>" onchange="fill_<?php echo $i ?>();" id="EpyDcr_<?php echo $i ?>" value="<?php echo $row_peg->EpyDcr ?>"/></td>
			<td><input type="text" style="width:150px; background-color: #eeffb5"  readonly name="Pangkat_<?php echo $i ?>" onchange="fill3_<?php echo $i ?>();" id="Pangkat_<?php echo $i ?>" value="<?php echo $row_peg->Pangkat ?>"/></td>
			<td><input type="text" style="width:100px; background-color: #eeffb5"  readonly name="Golongan_<?php echo $i ?>" onchange="fill4_<?php echo $i ?>();" id="Golongan_<?php echo $i ?>" value="<?php echo $row_peg->Golongan ?>"/></td>
			<td><input type="text" style="width:150px; background-color: #eeffb5"  readonly name="Jabatan_<?php echo $i ?>" onchange="fill5_<?php echo $i ?>();" id="Jabatan_<?php echo $i ?>" value="<?php echo $row_peg->Jabatan ?>"/></td>
			<td><input type="text" style="width:150px; background-color: #eeffb5"  readonly name="SubDit_<?php echo $i ?>" onchange="fill6_<?php echo $i ?>();" id="SubDit_<?php echo $i ?>" value="<?php echo $row_peg->SubDit ?>"/></td>
			
			<td align="center">
				<input type="checkbox" id="delete_<?php echo $i; ?>" name="delete_<?php echo $i; ?>" value="1" >
			</td>
